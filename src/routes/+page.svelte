...
<footer class="page-footer font-small blue fixed-bottom">
	<div class="footer-copyright text-center py-3">
		Created by:
		<a target="_blank" rel="noreferrer" href="https://twitter.com/bradyjhenry"> Brady Henry</a>
		-
		<a target="_blank" rel="noreferrer" href="https://github.com/bradyjhenry/Halfbold"> Github</a>
	</div>
</footer>
